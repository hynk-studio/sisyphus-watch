...
The patch does not overwrite the canonical card. It creates a reviewable proposal with suggested claim status changes, a possible next timeline event, claim drift suggestions, graph context, reviewer questions, and a v0.9 revision packet.
