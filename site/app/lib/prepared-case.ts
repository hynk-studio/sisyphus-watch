...
export const sources: SourceSnapshot[] = [
  {
    ...
    source_selection: {
      ...
      why_included: "Records the city's initial public cooling-center announcement.",
      classification_basis: "curated_fixture",
      classification_status: "curated_fixture_metadata",
  ...
  },
  {
    ...
    source_selection: {
      ...
      why_included: "Adds time-bound street-level observations about practical access.",
      classification_basis: "curated_fixture",
      classification_status: "curated_fixture_metadata",
      comparison_target_source_ids: [
  ...
  },
  {
    ...
    source_selection: {
      ...
      source_context: "official",
      information_proximity: "primary_actor_statement",
      why_included: "Records the later city correction and narrowing update.",
      classification_basis: "curated_fixture",
      classification_status: "curated_fixture_metadata",
      comparison_target_source_ids: [
        "src_city_heatwave_initial_announcement_2026_06_10",
  ...
  },
  {
    ...
    source_selection: {
      ...
      why_included: "Adds interpretive accountability context without becoming factual evidence.",
      classification_basis: "curated_fixture",
      classification_status: "curated_fixture_metadata",
      comparison_target_source_ids: [
        "src_city_heatwave_initial_announcement_2026_06_10",
